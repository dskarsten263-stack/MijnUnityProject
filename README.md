...
- Project en scene structuur begrijpen
...
## Wat ik heb geleerd
- Debug.Log() gebruiken
- Script aan GameObject koppelen
...
## Beschrijving
Spelerbeweging aanpassen met variabelen en simpele if-statements.

## Wat ik heb geleerd
- Variabelen gebruiken
- If-statements voor logica
...
## Beschrijving
Rigidbody toegevoegd aan GameObjects en botsingen getest.

## Wat ik heb geleerd
- Rigidbody component
- Collisions en physics toepassen
